import{t as e}from"./shaderStore-EocWwLxt.js";import"./ltcHelperFunctions-B9a1_lNk.js";import"./mainUVVaryingDeclaration-DMQ8ShOo.js";var t=`pbrFragmentExtraDeclaration`,n=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`pbrIBLFunctions`,m=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`pbrBlockNormalGeometric`,g=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`pbrBlockImageProcessing`,v=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`pbrBlockPrePass`,b=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`pbrDebug`,S=`#if DEBUGMODE>0
